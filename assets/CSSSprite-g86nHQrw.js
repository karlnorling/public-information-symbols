...
`,s.jsxs(e.p,{children:["Classes follow the pattern ",s.jsx(e.code,{children:"pi-{code}"})," where the code prefix and number are lowercased — e.g. ",s.jsx(e.code,{children:"pi-ac-001"}),", ",s.jsx(e.code,{children:"pi-pf-015"}),", ",s.jsx(e.code,{children:"pi-tf-001"}),"."]}),`
`,s.jsx(e.hr,{}),`
`,s.jsx(e.h2,{id:"all-symbols",children:"All symbols"}),`
`,s.jsx(i,{of:a}),`
`,s.jsx(e.hr,{}),`
`,s.jsx(e.h2,{id:"accessibility-ac",children:"Accessibility (AC)"}),`
`,s.jsx(i,{of:o}),`
`,s.jsx(e.hr,{}),`
`,s.jsx(e.h2,{id:"public-facilities-pf",children:"Public Facilities (PF)"}),`
`,s.jsx(i,{of:d}),`
`,s.jsx(e.hr,{}),`
`,s.jsx(e.h2,{id:"transportation-tf",children:"Transportation (TF)"}),`
`,s.jsx(i,{of:h})]})}function g(n={}){const{wrapper:e}={...l(),...n.components};return e?s.jsx(e,{...n,children:s.jsx(c,{...n})}):c(n)}export{g as default};
