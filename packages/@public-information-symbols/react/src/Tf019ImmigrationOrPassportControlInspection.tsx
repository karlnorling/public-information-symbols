...
export const Tf019ImmigrationOrPassportControlInspection = React.memo<SymbolProps>((props) =>
  renderSymbol(_parts, _title, _description, props, useSymbolUid()),
);
Tf019ImmigrationOrPassportControlInspection.displayName = 'Tf019ImmigrationOrPassportControlInspection';
