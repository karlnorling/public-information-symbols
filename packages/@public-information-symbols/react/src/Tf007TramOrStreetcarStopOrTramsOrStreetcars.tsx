...
export const Tf007TramOrStreetcarStopOrTramsOrStreetcars = React.memo<SymbolProps>(
...
Tf007TramOrStreetcarStopOrTramsOrStreetcars.displayName = 'Tf007TramOrStreetcarStopOrTramsOrStreetcars';
