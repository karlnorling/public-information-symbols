...
export const Ac008AccessibilityVisionImpaired = React.memo<SymbolProps>((props) =>
  renderSymbol(_parts, _title, _description, props, useSymbolUid()),
);
Ac008AccessibilityVisionImpaired.displayName = 'Ac008AccessibilityVisionImpaired';
