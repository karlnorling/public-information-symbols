...
export const Ac011PriorityAccessForInjuredPeople = React.memo<SymbolProps>(
...
Ac011PriorityAccessForInjuredPeople.displayName = "Ac011PriorityAccessForInjuredPeople";
