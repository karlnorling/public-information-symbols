...
export class Bp013OpenPassportAndPlaceOnScanningDevice extends PISymbolBase {
  static override readonly tagName = 'pi-bp-013-open-passport-and-place-on-scanning-device';
