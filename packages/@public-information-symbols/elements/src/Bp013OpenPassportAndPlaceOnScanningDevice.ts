...
export class Bp013OpenPassportAndPlaceOnScanningDevice extends HTMLElement {
  static readonly tagName = 'pi-bp-013-open-passport-and-place-on-scanning-device';
