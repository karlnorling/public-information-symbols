...
export class Tf007TramOrStreetcarStopOrTramsOrStreetcars extends HTMLElement {
  static readonly tagName = 'pi-tf-007-tram-or-streetcar-stop-or-trams-or-streetcars';
