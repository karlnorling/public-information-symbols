...
export class Tf044ElectricVehicleChargingStationOrPoint extends HTMLElement {
  static readonly tagName = 'pi-tf-044-electric-vehicle-charging-station-or-point';
