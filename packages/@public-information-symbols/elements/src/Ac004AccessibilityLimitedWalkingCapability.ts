...
export class Ac004AccessibilityLimitedWalkingCapability extends PISymbolBase {
  static override readonly tagName = 'pi-ac-004-accessibility-limited-walking-capability';
