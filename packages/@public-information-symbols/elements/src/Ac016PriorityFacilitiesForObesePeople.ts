...
export class Ac016PriorityFacilitiesForObesePeople extends PISymbolBase {
  static override readonly tagName = 'pi-ac-016-priority-facilities-for-obese-people';
