...
export class Tf019ImmigrationOrPassportControlInspection extends HTMLElement {
  static readonly tagName = 'pi-tf-019-immigration-or-passport-control-inspection';
