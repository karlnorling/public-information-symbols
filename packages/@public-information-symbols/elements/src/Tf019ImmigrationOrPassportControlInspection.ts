...
export class Tf019ImmigrationOrPassportControlInspection extends PISymbolBase {
  static override readonly tagName = 'pi-tf-019-immigration-or-passport-control-inspection';
