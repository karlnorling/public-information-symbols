...
export class Cf010ConferenceFacilitiesOrMeetingRoom extends PISymbolBase {
  static override readonly tagName = 'pi-cf-010-conference-facilities-or-meeting-room';
