...
export class Ac020PrioritySeatsForPeopleWithSmallChildren extends HTMLElement {
  static readonly tagName = "pi-ac-020-priority-seats-for-people-with-small-children";
