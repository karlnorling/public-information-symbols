...
export class Ac006AccessibilityPersonalAssistantAvailable extends HTMLElement {
  static readonly tagName = 'pi-ac-006-accessibility-personal-assistant-available';
