...
export class Ac006AccessibilityPersonalAssistantAvailable extends PISymbolBase {
  static override readonly tagName = 'pi-ac-006-accessibility-personal-assistant-available';
