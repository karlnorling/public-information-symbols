...
export class Ac019PrioritySeatsForPeopleWithInternalMedicalConditions extends HTMLElement {
  static readonly tagName = 'pi-ac-019-priority-seats-for-people-with-internal-medical-conditions';
