...
export class Tf003UndergroundOrMetroRailwayStationOrTrains extends HTMLElement {
  static readonly tagName = "pi-tf-003-underground-or-metro-railway-station-or-trains";
