...
export class Tf003UndergroundOrMetroRailwayStationOrTrains extends PISymbolBase {
  static override readonly tagName = 'pi-tf-003-underground-or-metro-railway-station-or-trains';
