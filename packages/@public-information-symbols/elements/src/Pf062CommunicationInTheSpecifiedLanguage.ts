...
export class Pf062CommunicationInTheSpecifiedLanguage extends PISymbolBase {
  static override readonly tagName = 'pi-pf-062-communication-in-the-specified-language';
