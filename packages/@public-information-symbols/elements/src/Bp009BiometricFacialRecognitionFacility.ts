...
export class Bp009BiometricFacialRecognitionFacility extends PISymbolBase {
  static override readonly tagName = 'pi-bp-009-biometric-facial-recognition-facility';
