...
export class Ac012PriorityAccessForPeopleWithInternalMedicalConditions extends HTMLElement {
  static readonly tagName = 'pi-ac-012-priority-access-for-people-with-internal-medical-conditions';
