...
export class Cf004MoneyCurrencyExchangeOrBureauDeChange extends HTMLElement {
  static readonly tagName = 'pi-cf-004-money-currency-exchange-or-bureau-de-change';
