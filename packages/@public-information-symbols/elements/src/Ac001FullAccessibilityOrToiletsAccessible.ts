...
export class Ac001FullAccessibilityOrToiletsAccessible extends PISymbolBase {
  static override readonly tagName = 'pi-ac-001-full-accessibility-or-toilets-accessible';
